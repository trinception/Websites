    ...
    <main className={styles.main}>
        ...
        <div className={styles.container}>
          ...
          <form action="" className={styles.form}>
            <input required="" className={styles.input} type="name" name="name" id="name" placeholder="Name"/>
            <input required="" className={styles.input} type="email" name="email" id="email" placeholder="E-mail"/>
            <input required="" className={styles.input} type="message" name="message" id="message" placeholder="Message"/>
